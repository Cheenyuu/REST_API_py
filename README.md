...
Just a general implementation to learn how to troubleshoot and build communication between a server and a client manually in Python.

## Purpose

My understanding of how a REST API works is incredibly limited (teetering on no knowledge at all right now) and I want to learn so this github repo will have a few things that I'm focusing on...
